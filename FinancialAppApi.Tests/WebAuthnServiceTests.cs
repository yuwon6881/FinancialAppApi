...
public class WebAuthnServiceTests
{
    ...
    public async Task ListCredentialsAsync_ReturnsOnlyUsersCredentials()
    {
        ...
        context.WebAuthnCredentials.AddRange(
            NewCredential("alice", [1, 2, 3], "Phone"),
            NewCredential("bob", [4, 5, 6], "Tablet"));
    ...
    private static WebAuthnCredential NewCredential(string username, byte[] credentialId, string label)
    {
